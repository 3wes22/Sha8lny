...
export const APP_ROUTE_META: AppRouteMeta[] = [
  ...
  },
  {
    ...
    path: ROUTES.courses,
    title: "Courses",
    description: "Browse and search courses across learning platforms.",
    protected: true,
    showInPrimaryNav: true,
    icon: BookOpen,
  },
  {
    ...
    title: "Progress",
    description: "Track learning hours, streaks, and milestones.",
    protected: true,
    showInPrimaryNav: true,
    icon: TrendingUp,
  },
  {
    key: "careerTools",
    path: ROUTES.careerTools,
    title: "Career Tools",
    description: "Build resumes and portfolios, and optimize for ATS.",
    protected: true,
    showInPrimaryNav: true,
    icon: FileText,
  },
