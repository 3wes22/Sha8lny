<!-- source: MDN Web Docs | url: https://developer.mozilla.org/en-US/docs/Web/HTTP/Overview
...
- Read the response sent by the server, such as: http HTTP/1.1 200 OK
...
- Glossary terms: HTTP HTTP/2 QUIC
