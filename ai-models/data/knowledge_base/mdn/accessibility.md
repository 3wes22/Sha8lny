<!-- source: MDN Web Docs | url: https://developer.mozilla.org/en-US/docs/Web/Accessibility
...
When the Web meets this goal, it is accessible to people with a diverse range of hearing, movement, sight, and cognitive ability. – ( W3C - Accessibility )

## Beginner's tutorials

Our learn web development Accessibility module contains modern, up-to-date tutorials covering accessibility fundamentals.
