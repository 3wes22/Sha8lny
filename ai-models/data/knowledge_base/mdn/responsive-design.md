<!-- source: MDN Web Docs | url: https://developer.mozilla.org/en-US/docs/Learn_web_development/Core/CSS_layout/Responsive_Design
...
Try resizing the browser window, as before, and note how this time the heading size increases gradually as the width changes.
...
There are a number of other options you can put inside the content attribute of the viewport meta tag — see the <meta name="viewport"> reference for more details.
...
- Working with touchscreen devices: Touch events provide the ability to interpret finger (or stylus) activity on touch screens or trackpads, enabling quality support for complex touch-based user interfaces. Use the pointer or any-pointer media queries to load different CSS on touch-enabled devices.
...
- The Frontend Developer Career Path MDN learning partner from Scrimba teaches all you need to know to be a competent front-end web developer, with fun interactive lessons and challenges, knowledgeable teachers, and a supportive community. Go from zero to landing your first front-end job! Many of the course components are available as standalone free versions. This includes a module on responsive design.
...
This page was last modified on Dec 19, 2025 by MDN contributors .
